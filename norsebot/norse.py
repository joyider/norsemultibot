...
from norsemultibot.config.config import config
from norsemultibot.resources.core.protocol.irc import IRC
from norsemultibot.resources.probes.blacklists import check_for_blacklist
from norsemultibot.resources.probes.commands import *
from norsemultibot.resources.probes.messages import save_message
from norsemultibot.resources.probes.moderators import get_moderator
from norsemultibot.resources.probes.points import *
...
def get_custom_command(channel, message, username):
	chan = channel.lstrip("#")
...
class norse(object):
	...
	def join_part(self, action, channel):
		...
		if action == "leave":
			...
			print("LEAVING {0}").format(channel)
